      ...
      <tbody>
        ...
        ?>
            <tr>
              ...
              <td>
                <a href="update_branch.php?uid=<?php echo $row['id'] ?>" class="btn btn-info" style="margin-right: 10px;">Update</a>
                <a href="delete_branch.php?uid=<?php echo $row['id'] ?>" class="btn btn-warning">Delete</a>
